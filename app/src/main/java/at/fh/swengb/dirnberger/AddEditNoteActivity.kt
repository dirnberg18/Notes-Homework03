...
class AddEditNoteActivity : AppCompatActivity(){
    ...
    companion object {val EXTRA_ADDED_OR_EDITED_RESULT = "ADD_OR_EDITED_RESULT"; val TOKEN = "TOKEN"}
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        if(extra != null){
            ...
            if(note != null){
                revise_notes_title.setText(note.title)
                revise_notes_text.setText(note.text)
            }
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean{
        return when(item?.itemId){
            R.id.savenote -> {
                ...
                if (
                    (extra != null) &&
                    (revise_notes_text.text.toString().isNotEmpty() || revise_notes_title.text.toString().isNotEmpty()) &&
                    (token != null))
                {
                    val note = Note(extra, revise_notes_title.text.toString(), revise_notes_text.text.toString(), true)
